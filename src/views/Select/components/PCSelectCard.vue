<template>
  <div class="pc-select__entire-body">
    <v-card hover class="pc-select__card">
      <!-- <v-card-text>
        <div class="pc-select__title-head-left">
          <v-chip small color="purple" depressed dark>For Employers</v-chip>
        </div>
        <div class="pc-select__title-head-right"></div>
      </v-card-text> -->

      <!-- <slot name="image">
        <v-img
          class="pc-select__image"
          height="150px"
